...
@section('content')
    ...
    <div class="content-wrapper">
        <div class="content-header">
                        ...
                        <div class="card-header" style="padding:2cm 2cm 2cm 3cm">
                            <div class="d-flex">
                                ...
                                <div class="p-2 flex-fill" style="font-size:14px;margin-top:5px">
                                    <h5 style="font-weight:bold; font-size:16px"> บริษัท ไอดีไดรฟ์ จำกัด (สำนักงานใหญ่)
                                    </h5>
                                    200/222 หมู่2 ถนนชัยพฤกษ์ ตำบลในเมือง อำเภอเมืองขอนแก่น จังหวัดขอนแก่น 40000
                                    เลขที่ผู้เสียภาษี 0405536000531 <br>
                                    Tel : 043-228 899 www.iddrives.co.th Email : idofficer@iddrives.co.th <br>
                                </div>
                            </div>
                            ...
                            <div class="card-body" style="margin-top:30px;padding:unset">
                                <form action="{{ url('/form/add') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="d-flex justify-content-end">
                                        @if ($shortname == 'ไอที')
                                            <input type="hidden" value="ITI" class="form-control" style="width: 60px"
                                                name="fdepartment">
                                            @if ($iti == null)
                                                <input type="hidden" value="001" class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @elseif($iti <= 8)
                                                <input type="hidden" value=<?php echo '00' . $iti + 1; ?> class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @elseif($iti >= 9)
                                                <input type="hidden" value=<?php echo '0' . $iti + 1; ?> class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @elseif($iti >= 99)
                                                <input type="hidden" value=<?php echo $iti + 1; ?> class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @endif
                                            @if ($total == null)
                                                <input type="hidden" value="001" class="form-control"
                                            ...
                                            @elseif($total >= 99)
                                                <input type="hidden" value=<?php echo $total + 1; ?> class="form-control"
                                                    style="width: 60px" name="cnumber">
                                            @endif
                                            <input type="hidden" value=<?php echo $year; ?> class="form-control"
                                                style="width: 50px" name="year">
                                        @elseif($shortname == 'บัญชี')
                                            <input type="hidden" value="ACC" class="form-control" style="width: 60px"
                                                name="fdepartment">
                                            @if ($acc == null)
                                                <input type="hidden" value="001" class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @elseif($acc <= 8)
                                                <input type="hidden" value=<?php echo '00' . $acc + 1; ?> class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @elseif($acc >= 9)
                                                <input type="hidden" value=<?php echo '0' . $acc + 1; ?> class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @elseif($acc >= 99)
                                                <input type="hidden" value=<?php echo $acc + 1; ?> class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @endif
                                            @if ($total == null)
                                                <input type="hidden" value="001" class="form-control"
                                            ...
                                            <input type="hidden" value=<?php echo $year; ?> class="form-control"
                                                style="width: 50px" name="year">
                                        @elseif($shortname == 'จัดซื้อ')
                                            <input type="hidden" value="PUR" class="form-control"
                                                style="width: 60px" name="fdepartment">
                                            @if ($pur == null)
                                                <input type="hidden" value="001" class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @elseif($pur <= 8)
                                                <input type="hidden" value=<?php echo '00' . $pur + 1; ?> class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @elseif($pur >= 9)
                                                <input type="hidden" value=<?php echo '0' . $pur + 1; ?> class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @elseif($pur >= 99)
                                                <input type="hidden" value=<?php echo $pur + 1; ?> class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @endif
                                            @if ($total == null)
                                                <input type="hidden" value="001" class="form-control"
                                            ...
                                            <input type="hidden" value=<?php echo $year; ?> class="form-control"
                                                style="width: 50px" name="year">
                                        @elseif($shortname == 'บุคคล')
                                            <input type="hidden" value="HR" class="form-control"
                                                style="width: 60px" name="fdepartment">
                                            @if ($hr == null)
                                                <input type="hidden" value="001" class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @elseif($hr <= 8)
                                                <input type="hidden" value=<?php echo '00' . $hr + 1; ?> class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @elseif($hr >= 9)
                                                <input type="hidden" value=<?php echo '0' . $hr + 1; ?> class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @elseif($hr >= 99)
                                                <input type="hidden" value=<?php echo $hr + 1; ?> class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @endif
                                            @if ($total == null)
                                                <input type="hidden" value="001" class="form-control"
                                            ...
                                            <input type="hidden" value=<?php echo $year; ?> class="form-control"
                                                style="width: 50px" name="year">
                                        @elseif($shortname == 'ธุรการ')
                                            <input type="hidden" value="AD" class="form-control"
                                                style="width: 60px" name="fdepartment">
                                            @if ($ad == null)
                                                <input type="hidden" value="001" class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @elseif($ad <= 8)
                                                <input type="hidden" value=<?php echo '00' . $ad + 1; ?> class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @elseif($ad >= 9)
                                                <input type="hidden" value=<?php echo '0' . $ad + 1; ?> class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @elseif($ad >= 99)
                                                <input type="hidden" value=<?php echo $ad + 1; ?> class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @endif
                                            @if ($total == null)
                                                <input type="hidden" value="001" class="form-control"
                                            ...
                                            <input type="hidden" value=<?php echo $year; ?> class="form-control"
                                                style="width: 50px" name="year">
                                        @elseif($shortname == 'การเงิน')
                                            <input type="hidden" value="FIN" class="form-control"
                                                style="width: 60px" name="fdepartment">
                                            @if ($fin == null)
                                                <input type="hidden" value="001" class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @elseif($fin <= 8)
                                                <input type="hidden" value=<?php echo '00' . $fin + 1; ?> class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @elseif($fin >= 9)
                                                <input type="hidden" value=<?php echo '0' . $fin + 1; ?> class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @elseif($fin >= 99)
                                                <input type="hidden" value=<?php echo $fin + 1; ?> class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @endif
                                            @if ($total == null)
                                                <input type="hidden" value="001" class="form-control"
                                            ...
                                            <input type="hidden" value=<?php echo $year; ?> class="form-control"
                                                style="width: 50px" name="year">
                                        @elseif($shortname == 'การตลาด')
                                            <input type="hidden" value="MKT" class="form-control"
                                                style="width: 60px" name="fdepartment">
                                            @if ($mkt == null)
                                                <input type="hidden" value="001" class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @elseif($mkt <= 8)
                                                <input type="hidden" value=<?php echo '00' . $mkt + 1; ?> class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @elseif($mkt >= 9)
                                                <input type="hidden" value=<?php echo '0' . $mkt + 1; ?> class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @elseif($mkt >= 99)
                                                <input type="hidden" value=<?php echo $mkt + 1; ?> class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @endif
                                            @if ($total == null)
                                                <input type="hidden" value="001" class="form-control"
                                            ...
                                            <input type="hidden" value=<?php echo $year; ?> class="form-control"
                                                style="width: 50px" name="year">
                                        @elseif($shortname == 'บริหารงานพัฒนาผลิตภัณฑ์')
                                            <input type="hidden" value="ITD" class="form-control"
                                                style="width: 60px" name="fdepartment">
                                            @if ($itd == null)
                                                <input type="hidden" value="001" class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @elseif($itd <= 8)
                                                <input type="hidden" value=<?php echo '00' . $itd + 1; ?> class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @elseif($itd >= 9)
                                                <input type="hidden" value=<?php echo '0' . $itd + 1; ?> class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @elseif($itd >= 99)
                                                <input type="hidden" value=<?php echo $itd + 1; ?> class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @endif
                                            @if ($total == null)
                                                <input type="hidden" value="001" class="form-control"
                                            ...
                                            <input type="hidden" value=<?php echo $year; ?> class="form-control"
                                                style="width: 50px" name="year">
                                        @elseif($shortname == 'เซลล์')
                                            <input type="hidden" value="SALE" class="form-control"
                                                style="width: 70px" name="fdepartment">
                                            @if ($sale == null)
                                                <input type="hidden" value="001" class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @elseif($sale <= 8)
                                                <input type="hidden" value=<?php echo '00' . $sale + 1; ?> class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @elseif($sale >= 9)
                                                <input type="hidden" value=<?php echo '0' . $sale + 1; ?> class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @elseif($sale >= 99)
                                                <input type="hidden" value=<?php echo $sale + 1; ?> class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @endif
                                            @if ($total == null)
                                                <input type="hidden" value="001" class="form-control"
                                            ...
                                            <input type="hidden" value=<?php echo $year; ?> class="form-control"
                                                style="width: 50px" name="year">
                                        @elseif($shortname == 'กฎหมาย')
                                            <input type="hidden" value="LEG" class="form-control"
                                                style="width: 60px" name="fdepartment">
                                            @if ($leg == null)
                                                <input type="hidden" value="001" class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @elseif($leg <= 8)
                                                <input type="hidden" value=<?php echo '00' . $leg + 1; ?> class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @elseif($leg >= 9)
                                                <input type="hidden" value=<?php echo '0' . $leg + 1; ?> class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @elseif($leg >= 99)
                                                <input type="hidden" value=<?php echo $leg + 1; ?> class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @endif
                                            @if ($total == null)
                                                <input type="hidden" value="001" class="form-control"
                                            ...
                                            <input type="hidden" value=<?php echo $year; ?> class="form-control"
                                                style="width: 50px" name="year">
                                        @elseif($shortname == 'ส่วนงานเลขานุการ')
                                            <input type="hidden" value="CS" class="form-control"
                                                style="width: 60px" name="fdepartment">
                                            @if ($cs == null)
                                                <input type="hidden" value="001" class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @elseif($cs <= 8)
                                                <input type="hidden" value=<?php echo '00' . $cs + 1; ?> class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @elseif($cs >= 9)
                                                <input type="hidden" value=<?php echo '0' . $cs + 1; ?> class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @elseif($cs >= 99)
                                                <input type="hidden" value=<?php echo $cs + 1; ?> class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @endif
                                            @if ($total == null)
                                                <input type="hidden" value="001" class="form-control"
                                            ...
                                            <input type="hidden" value=<?php echo $year; ?> class="form-control"
                                                style="width: 50px" name="year">
                                        @elseif($shortname == 'ส่วนงานบริหารงานคุณภาพ')
                                            <input type="hidden" value="ISO" class="form-control"
                                                style="width: 60px" name="fdepartment">
                                            @if ($iso == null)
                                                <input type="hidden" value="001" class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @elseif($iso <= 8)
                                                <input type="hidden" value=<?php echo '00' . $iso + 1; ?> class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @elseif($iso >= 9)
                                                <input type="hidden" value=<?php echo '0' . $iso + 1; ?> class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @elseif($iso >= 99)
                                                <input type="hidden" value=<?php echo $iso + 1; ?> class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @endif
                                            @if ($total == null)
                                                <input type="hidden" value="001" class="form-control"
                                            ...
                                            <input type="hidden" value=<?php echo $year; ?> class="form-control"
                                                style="width: 50px" name="year">
                                        @elseif($shortname == 'พัฒนาผลิตภัณฑ์')
                                            <input type="hidden" value="IDC" class="form-control"
                                                style="width: 60px" name="fdepartment">
                                            @if ($idc == null)
                                                <input type="hidden" value="001" class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @elseif($idc <= 8)
                                                <input type="hidden" value=<?php echo '00' . $idc + 1; ?> class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @elseif($idc >= 9)
                                                <input type="hidden" value=<?php echo '0' . $idc + 1; ?> class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @elseif($idc >= 99)
                                                <input type="hidden" value=<?php echo $idc + 1; ?> class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @endif
                                            @if ($total == null)
                                                <input type="hidden" value="001" class="form-control"
                                            ...
                                            <input type="hidden" value=<?php echo $year; ?> class="form-control"
                                                style="width: 50px" name="year">
                                        @elseif($shortname == 'คลังสินค้า')
                                            <input type="hidden" value="IDS" class="form-control"
                                                style="width: 60px" name="fdepartment">
                                            @if ($ids == null)
                                                <input type="hidden" value="001" class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @elseif($ids <= 8)
                                                <input type="hidden" value=<?php echo '00' . $ids + 1; ?> class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @elseif($ids >= 9)
                                                <input type="hidden" value=<?php echo '0' . $ids + 1; ?> class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @elseif($ids >= 99)
                                                <input type="hidden" value=<?php echo $ids + 1; ?> class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @endif
                                            @if ($total == null)
                                                <input type="hidden" value="001" class="form-control"
                                            ...
                                            <input type="hidden" value=<?php echo $year; ?> class="form-control"
                                                style="width: 50px" name="year">
                                        @elseif($shortname == 'บริหารงานโครงการ')
                                            <input type="hidden" value="PM" class="form-control"
                                                style="width: 60px" name="fdepartment">
                                            @if ($pm == null)
                                                <input type="hidden" value="001" class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @elseif($pm <= 8)
                                                <input type="hidden" value=<?php echo '00' . $pm + 1; ?> class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @elseif($pm >= 9)
                                                <input type="hidden" value=<?php echo '0' . $pm + 1; ?> class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @elseif($pm >= 99)
                                                <input type="hidden" value=<?php echo $pm + 1; ?> class="form-control"
                                                    style="width: 60px" name="dnumber">
                                            @endif
                                            @if ($total == null)
                                                <input type="hidden" value="001" class="form-control"
                ...
                FD-HO/HR-013/1 :00: 19-09-2563
                            ...
                            <div class="d-flex justify-content-center">
                                <div style="width:80%">
                                    ...
                                    <div
                                        style="border: 2px solid #000000; overflow: auto; width: auto; height: auto; text-align: center;width:100%">
                                        ...
                                        <img src="{{ asset('dist/img/logo13.jpg') }}" width="81px">
            ...
            <div class="d-flex justify-content-end">
                <input type="hidden" value="บริษัทไอดีไดรฟ์จำกัด(สำนักงานใหญ่)" class="form-control"
                    placeholder="กรุณากรอกการอ้างถึง" style="width: 300px" name="type">
            </div><br>
            <!-- save cancel -->
