...
@section('content')
    ...
    <style>
        ...
        @page {
            ...
            size: "A4";
            /* Define the paper size, you can use 'A4', 'letter', etc. */
        }
            ...
            <div class="font1">
                <div class="card">
                    <div class="card-header" style="border: 0px;">
                        ...
                        @if ($form->type == 'โรงเรียนสอนขับรถไอดีไดร์ฟเวอร์')
                            ...
                            <div class="">
                                ...
                                <h5 style="font-weight:bold;margin-bottom:0;font-size:20px">โรงเรียนสอนขับรถไอดี ไดร์ฟเวอร์
                                    สาขา{{ $bName }}
                                    <span style="font-size:13pt;font-weight:400;font-weight:bold;">เลขที่ผู้เสียภาษี
                                        0405536000531</span>
                                </h5>
                                <p style="font-size:18px; margin:unset;">ที่อยู่: {{ $bAddr[0] }} <br>Tel:
                                    {{ $bAddr[1] ?? ('' ?? '') }}</p>
                                <p style="font-size:16px; margin:unset;">บริหารงานโดย บริษัท ไอดีไดรฟ์ จำกัด </p>
                                <div class="" style="font-size:16px; ">
                                    ที่อยู่ 200/222 หมู่2 ถนนชัยพฤกษ์ อำเภอเมืองขอนแก่น จังหวัดขอนแก่น 40000 Tel : 043-228
                                    899 Email : idofficer@iddrives.co.th
                                    <br>
                                </div>
                            </div>
                        ...
                        @elseif($form->type == 'บริษัทไอดีไดรฟ์จำกัด(สำนักงานใหญ่)')
                            <div class="d-flex">
                                ...
                                <div class="flex-fill" style="font-size:14pt; margin-top: 10px">
                                    ...
                                    200/222 หมู่2 ถนนชัยพฤกษ์ อำเภอเมืองขอนแก่น จังหวัดขอนแก่น เลขที่ผู้เสียภาษี
                                    0405536000531 <br>
                        ...
                        @elseif($form->type == 'สถานตรวจสภาพรถศูนย์ตรอ.ไอดี')
                            ...
                            <div class="">
                                ...
                                <h5 style="font-size:20px;font-weight:bold;margin-bottom:0">สถานตรวจสภาพรถ ศูนย์ตรอ.ไอดี
                                    สาขา{{ $bName }}
                                    <span style="font-size:13pt;">เลขที่ผู้เสียภาษี 0405536000531</span>
                                </h5>
                                <p style="font-size:18px; margin:unset;">ที่อยู่: {{ $bAddr[0] }} <br>Tel:
                                    {{ $bAddr[1] ?? '' }}</p>
                                <p style="font-size:16px; margin:unset;">บริหารงานโดย บริษัท ไอดีไดรฟ์ จำกัด</p>
                        ...
                        @elseif($form->type == 'ศูนย์ฝึกอบรม')
                            ...
                            <br>
                            <div class="">
                                <h5 style="font-size:20px;font-weight:bold;margin-bottom:0">ศูนย์ฝึกอบรมเทรนนิ่งเซนเตอร์
                                    <span style="font-size:13pt;">เลขที่ผู้เสียภาษี 0405536000531</span>
                                </h5>
                                <p style="font-size:18px; margin:unset;">ที่อยู่: 58/1 ม.9 ถ.มิตรภาพ ต.ทับกวาง อ.แก่งคอย
                        ...
                        @elseif($form->type == 'โรงเรียนไอดีสอนทักษะอาชีพ')
                            <div class="d-flex justify-content-center" style="text-align:center; ">
                                ...
                                <div class="align-self-center mx-3">
                                    ...
                                    <h5 style="font-size:20px;font-weight:bold;margin-bottom:0">ID Vocational Skill Training
                                        School</h5>
                                </div>
                                &nbsp;&nbsp;
                                <img src="{{ asset('dist/img/logoiddrives.png') }}"height="80">
                            ...
                            <div class="mt-2">
                                ...
                                <p style="font-size:12px; margin:unset;">บริหารงานโดย บริษัท ไอดีไดรฟ์ จำกัด ที่อยู่ 200/222
                                    หมู่2 ถนนชัยพฤกษ์ ตำบลในเมือง อำเภอเมืองขอนแก่น จังหวัดขอนแก่น 40000</p>
                    ...
                    <div class="card-body" style="padding: 1cm 0 0 1cm;">
                        ...
                        @if ($form->copy_to !== null)
                            <div class="d-flex justify-content-start"style="margin-top:15px;">
                                <p class="text-nowrap" style="margin-right: 10px; margin-bottom: 0;"><b>สำเนาถึง</b></p>
                                <p style="margin-bottom: 0">{{ $form->copy_to }}</p>
                            </div>
                        @endif
                        ...
                        @else
                            <div class="d-flex justify-content-start"style="margin-top:15px;">
                                <p class="text-nowrap" style="margin-right: 10px; margin-bottom: 0"><b>อ้างถึง</b></p>
                                <p style="margin-bottom: 0">{{ $form->quote }}</p>
                            </div>
                        @endif
                        ...
                        @else
                            <div class="d-flex" style="margin-right:10px;margin-top:15px;">
                                ...
                                <div class="flex-grow-1 ms-3" style="text-align: justify;">
                                    ...
                                    <input type="hidden" value="{{ $form->enclosure }}" class="form-control"
                    ...
                    <div class="footer mt-auto" style="margin-top: 20px;">
                        <div class="d-flex justify-content-center">
                            <div class="w-100">
                                {{-- @if ($form->type == 'โรงเรียนไอดีสอนทักษะอาชีพ')
                                    <div class="d-flex justify-content-around ">
                                ...
                                @else
                                    <div style="width:fit-content; position:relative; left:65%" class="mb-4">
                                        <div style="text-align:center">
                                            <!-- <div class="d-flex justify-content-center"> -->
                                            {{ $form->regard }}
                                        </div>
                                ...
                                @endif --}}
                                <div class="d-flex justify-content-end" style="margin-bottom:10px; font-size: 14px;">
                                    @if ($form->type == 'โรงเรียนสอนขับรถไอดีไดร์ฟเวอร์')
                                ...
                                <div
                                    style="border: 2px solid #000000; overflow: auto; width: 200mm; height: auto; text-align: center; margin-left: 80px; padding: 5px 0px;">
